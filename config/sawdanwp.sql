...
--
-- Host: localhost:3306
-- Generation Time: Oct 10, 2025 at 12:02 AM
...
INSERT INTO `alternatives` (`id`, `name`, `value1`, `value2`, `value3`, `value4`, `value5`, `value6`, `value7`, `value8`, `value9`, `value10`, `value11`, `value12`) VALUES
(1, 'Toto Iswanto', 60, 100, 20, 60, 79, 20, 10, 30, 80, 70, 60, 40),
(2, 'Budiman Jaya', 70, 90, 10, 10, 67, 70, 68, 68, 98, 39, 17, 80),
(3, 'Aditya Parawansyah', 40, 90, 80, 80, 50, 67, 83, 78, 39, 67, 87, 88);
...
(11, 'e-Channel', 2, 'benefit', 'individu'),
(12, 'Referal JakOne', 2, 'benefit', 'individu');
...
INSERT INTO `users` (`id_users`, `username`, `password`, `role`, `nama`) VALUES
(1, 'Anjas90', '$2y$10$MX9jpleY4IWVZYnmL7ihoeth4twN3pUB9ChZDqQpI5QNxacDiZPey', 'superAdmin', 'Anjas Kosasih'),
(2, 'Tois23', '$2y$10$MX9jpleY4IWVZYnmL7ihoeth4twN3pUB9ChZDqQpI5QNxacDiZPey', 'admin', 'Toto Iswanto'),
(3, 'jaya09', '$2y$10$aZ1uWrcv682Yby77YN8WD.wuhaYvxDsjiyAMICREohDVK06/WSwaC', 'karyawan', 'Budiman Jaya'),
(4, 'Aditya_10', '$2y$10$ZNBDw6SOR6fYEz3O.6cbNuYjlloiyJvn8XY2e1/ae5OvKIA7x7lwi', 'karyawan', 'Aditya Parawansyah');
