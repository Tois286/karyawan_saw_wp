...
<div class="panel panel-container" style="padding: 20px; box-shadow: 2px 2px 5px #888888;">
    ...
    <a href="../config/add_criteria.php" class="btn btn-primary"><span class="fa fa-plus"></span>&emsp; Tambah Data</a>
                ...
                <?php foreach ($criterias as $criteria) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="../config/edit_criteria.php?id=<?php echo $criteria['id']; ?>&aksi=ubah" class="btn btn-info"><span class="fa fa-pencil"></span> Edit</a>
